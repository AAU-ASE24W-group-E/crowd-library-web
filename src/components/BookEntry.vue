        ...
        <div class="flex flex-row max-sm:flex-col max-sm:mt-2 sm:space-x-8 max-sm:space-y-2">
          ...
          <div class="flex flex-col">
            ...
            <span v-if="isSearchBook || deadline != null" class="tw-book-entry-info-title"
              >Owner: <span class="tw-book-entry-info-value">{{ ownBook.owner.name }} <span class="tw-book-entry-info-value"><font-awesome-icon :icon="faStar" class="text-yellow-500"/>{{ mockRatingValue }} ({{ mockRatingNumber }})</span></span></span
            >
