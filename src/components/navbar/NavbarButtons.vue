<template>
  <div class="flex items-center flex-row justify-between space-x-6 max-lg:space-x-5 max-sm:space-x-6" ref="dropdownRef">
    ...
    <div class="tw-navbar-dropdown-container w-[40px] max-md:w-[40px] max-sm:w-[35px] p-0" ref="themeDropdownRef">
      <button @click="handleThemeDropdownClick" id="theme-button" class="navbar-button-container p-0 btn-primary">
        <img v-if="selectedTheme === Theme.Light" :draggable=false src="../../assets/sun.svg"
          class="tw-icon w-[80px] h-auto object-contain" alt="" />
      ...
      <div v-if="themeDropdownOpen" class="right-0 w-28 tw-dropdown-inner-layout">
        <a @click="selectTheme(Theme.Light)" class="tw-dropdown-inner-action-layout" id="light-option">
          <svg class="fill-gray-700 dark:fill-gray-300 tw-navbar-dropdown-icon h-7" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512">
            <g>
              <g>
                <path
    ...
    <div class="tw-navbar-dropdown-container">
      <button @click="handleAccountClick" id="account-button" class="navbar-button-container btn-primary">
      ...
      <div v-if="accountDropdownOpen" class="-right-4 w-44 tw-dropdown-inner-layout">
        <div v-if="loggedIn">
          <a class="px-2 py-2 text-base text-gray-700 dark:text-title-dark-mode-text flex items-center cursor-default">
